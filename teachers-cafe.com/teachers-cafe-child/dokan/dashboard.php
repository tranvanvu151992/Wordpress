...
<div class="dokan-dashboard-wrap">
    ...
    ?>
    <input type="hidden" name="total_size" id="total_size_file" value="<?php echo $total; ?>">
    <input id="current_count_file" name="current_count_file" type="hidden" value="<?php echo $total; ?>" /> 
    <?php //dokan_get_template( 'dashboard-nav.php', array( 'active_menu' => 'product' ) ); ?>
    <?php //echo progressbar(); 
        if(current_user_can('free_membership')){
            echo '<span class="count-file">تم تحميلها '.count_files().'/4 ملفات</span>';
        }
    ?>
    
<script type="text/javascript">
jQuery(document).ready(function($){
    jQuery(".content-relation > #product_cat").change(function() {
            ...
            <h1 class="entry-title">
                <?php if ( !$post_id ): ?>
                        ...
                        <script type="text/javascript">
                            jQuery(document).ready(function($){
                                $('.dokan-btn.dokan-btn-theme.dokan-btn-lg.btn-block').click(function(e){
                                    ...
                                    var ajaxurl = 'https://www.teachers-cafe.com/wp-admin/admin-ajax.php';     
                                    var data = {
                    ...
                    <?php }else if(current_user_can('free_membership')){ ?>
                        <script type="text/javascript">
                            jQuery(document).ready(function($){
                              // jQuery('a.dokan-btn.dokan-btn-sm.dokan-btn-danger.delete').click(function(){
                              //       var current_count = jQuery('#current_count_file').val();
                              //       var ajaxurl = 'http://www.teachers-cafe.com/wp-admin/admin-ajax.php';     
                              //       var data = {
                              ...
                              //       jQuery.post(ajaxurl, data, function(response) {
                              //           if(response != ''){
                              //              jQuery('.current_count_file').val(response);     
                              //           }
                              //       });
                              //   });
                               jQuery('input.dokan-btn.dokan-btn-theme.dokan-btn-lg.btn-block').click(function(e){
                                    var current_count = jQuery('#current_count_file').val();
                                    //alert(current_count);
                                    var ajaxurl = 'https://www.teachers-cafe.com/wp-admin/admin-ajax.php';     
                                    var data = {
                                    ...
                                    jQuery.post(ajaxurl, data, function(response) {
                                        if(response != ''){
                                           jQuery('#result_file').html(response);
                ...
                <?php else: ?>
                    ...
                    <?php if ( $post->post_status == 'publish' ) { ?>
                        <span class="dokan-right">
                            <a class="view-product dokan-btn dokan-btn-sm" href="<?php echo get_permalink( $post->ID ); ?>" target="_blank"><?php _e( 'عرض المنتج', 'dokan' ); ?></a>
                        </span>
                    <?php } ?>

                    <?php if ( $_visibility == 'hidden' ) { ?>
                        <span class="dokan-right dokan-label dokan-label-default dokan-product-hidden-label"><i class="fa fa-eye-slash"></i> <?php _e( 'مخفي', 'dokan' ); ?></span>
                    <?php } ?>
        ...
        <div class="product-edit-new-container">
            ...
            <?php if ( isset( $_GET['message'] ) && $_GET['message'] == 'success') { ?>
                <div class="dokan-message">
                    ...
                    <strong><?php _e( 'نجاح!', 'dokan' ); ?></strong> <?php _e( 'تم حفظ المنتج بنجاح.', 'dokan' ); ?>

                    <?php if ( $post->post_status == 'publish' ) { ?>
                        <a href="<?php echo get_permalink( $post_id ); ?>" target="_blank"><?php _e( 'عرض المنتج &rarr;', 'dokan' ); ?></a>
                    <?php } ?>
                </div>
            <?php } ?>
                    ...
                    <form id="upload-f" class="dokan-product-edit-form" role="form" method="post">
                        ...
                        <div class="dokan-form-top-area">
                            ...
                            <div class="content-half-part">
                                ...
                                <div class="dokan-form-group">
                                    ...
                                    <label for="post_title" class="form-label"><?php _e( 'عنوان', 'dokan' ); ?></label>
                                    <?php dokan_post_input_box( $post_id, 'post_title', array( 'placeholder' => __( 'اسم المنتج..', 'dokan' ), 'value' => $post_title ) ); ?>
                                </div>
                                <div class="dokan-product-short-description">
                                    <input type="hidden" name="dokan_product_id" value="<?php echo $post_id; ?>"/>
                                    <label for="post_excerpt" class="form-label"><?php _e( 'مجردة من ملف', 'dokan' ); ?></label>
                                    <?php dokan_post_input_box( $post_id, 'post_excerpt', array( 'placeholder' => __( '250 الشخصيات.', 'dokan' ), 'value' => $post_excerpt),'textarea' ); ?>
                                </div>
                             <div class=" dokan-clearfix" style="display: none;">
                                ...
                                <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                    <div class="dokan-form-group">
                                        <label for="edu-Country" class="form-label"><?php _e( 'بلد المحتوى التعليمي', 'dokan' ); ?></label>
                                        <?php
                                        $eduCountry = -1;
                                        $eduCountry = array();
                                        ...
                                        wp_dropdown_categories( array(
                                            'show_option_none' => __( '- اختر البلد التربوي -', 'dokan' ),
                                            'hierarchical'     => 1,
                                            'hide_empty'       => 0,
                                            'name'             => 'edu-Country',
                                            'id'               => 'edu-Country',
                                ...
                                <?php elseif ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'multiple' ): ?>
                                    <div class="dokan-form-group dokan-list-category-box">
                                        <h5><?php _e( 'اختيار البلد التربوي', 'dokan' );  ?></h5>
                                ...
                                <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                    <div class="dokan-form-group">
                                        <label for="edu-type" class="form-label"><?php _e( 'نوع التعليم', 'dokan' ); ?></label>
                                        <?php
                                        $edutype = -1;
                                        $edutype = array();
                                        ...
                                        wp_dropdown_categories( array(
                                            'show_option_none' => __( '- اختر نوع التربوي -', 'dokan' ),
                                            'hierarchical'     => 1,
                                            'hide_empty'       => 0,
                                            'name'             => 'edu-type',
                                            'id'               => 'edu-type',
                                ...
                                <?php elseif ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'multiple' ): ?>
                                    <div class="dokan-form-group dokan-list-category-box">
                                        <h5><?php _e( 'اختر نوع التربوي', 'dokan' );  ?></h5>
                                        <ul class="dokan-checkbox-cat">
                                            <?php
                                            $edutype = array();
                                            $edutype = wp_get_post_terms( $post_id, 'edu-type', array( 'fields' => 'ids') );
                                ...
                                <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                    <div class="dokan-form-group">
                                        <label for="disability-type" class="form-label"><?php _e( 'نوع الإعاقة', 'dokan' ); ?></label>
                                        <?php
                                        $disability = -1;
                                        $disability = array();
                                        ...
                                        wp_dropdown_categories( array(
                                            'show_option_none' => __( '- اختر نوع الإعاقة -', 'dokan' ),
                                            'hierarchical'     => 1,
                                            'hide_empty'       => 0,
                                    ...
                                    <?php elseif ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'multiple' ): ?>
                                        <div class="dokan-form-group dokan-list-category-box">
                                            <h5><?php _e( 'اختر نوع الإعاقة', 'dokan' );  ?></h5>
                                            <ul class="dokan-checkbox-cat">
                                            <?php
                                            $disability = array();
                                            $disability = wp_get_post_terms( $post_id, 'disability-type', array( 'fields' => 'ids') );
                                ...
                                <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                    <div class="dokan-form-group content-relation">
                                        <label for="product_cat" class="form-label"><?php _e('المحتوى التعليمي', 'dokan' ); ?></label>
                                        <?php
                                        $product_cat = -1;
                                        $term = array();
                                        ...
                                        wp_dropdown_categories( array(
                                            'show_option_none' => __( '- اختر تصنيف -', 'dokan' ),
                                            'hierarchical'     => 1,
                                            'hide_empty'       => 0,
                                            'name'             => 'product_cat',
                                            'id'               => 'product_cat',
                                ...
                                <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                    <div class="dokan-form-group file_type">
                                        <label for="file-type" class="form-label"><?php _e( 'نوع الملف', 'dokan' ); ?></label>
                                        <?php 
                                        ...
                                        <option value="-1" >- حدد نوع الملف -</option>
                                        <?php 
                                        $i=1;
                                ...
                                <div class="dokan-form-group select_price" style="display: none;" >
                                    <label for="select-price" class="form-label"><?php _e( 'حدد الأسعار', 'dokan' ); ?></label>
                                    <?php 
                                        $product_price = array();
                                        ...
                                        <option value="-1">- حدد الأسعار -</option>
                                        <?php 
                                       // $i=0;
                                        //foreach($myArray as $my_Array){ 
                                           // echo '<option class="level-'.$i.'" value="'.$my_Array.'">$ '.$//my_Array.'</option>';                                                    
                                ...
                                <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                    <div class="dokan-form-group hide_cat_special">
                                        <label for="subject" class="form-label"><?php _e( 'موضوع', 'dokan' ); ?></label>
                                        <?php
                                        $subject = -1;
                                        $subject = array();
                                        ...
                                        wp_dropdown_categories( array(
                                            'show_option_none' => __( '- اختيار موضوع -', 'dokan' ),
                                            'hierarchical'     => 1,
                                            'hide_empty'       => 0,
                                            'name'             => 'subject',
                                            'id'               => 'subject',
                                ...
                                <?php elseif ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'multiple' ): ?>
                                    <div class="dokan-form-group dokan-list-category-box">
                                        <h5><?php _e( 'اختيار موضوع', 'dokan' );  ?></h5>
                                        <ul class="dokan-checkbox-cat">
                                        <?php
                                        $subject = array();
                                        $subject = wp_get_post_terms( $post_id, 'subject', array( 'fields' => 'ids') );
                                ...
                                <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                    <div class="dokan-form-group hide_cat_special">
                                        <label for="grade" class="form-label"><?php _e( 'درجة', 'dokan' ); ?></label>
                                        <?php
                                        $grade = -1;
                                        $grade = array();
                                        ...
                                        wp_dropdown_categories( array(
                                            'show_option_none' => __( '- حدد الصف -', 'dokan' ),
                                            'hierarchical'     => 1,
                                            'hide_empty'       => 0,
                                            'name'             => 'grade',
                                            'id'               => 'grade',
                                ...
                                <?php elseif ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'multiple' ): ?>
                                    <div class="dokan-form-group dokan-list-category-box">
                                        <h5><?php _e( 'اختيار الصف', 'dokan' );  ?></h5>
                                        <ul class="dokan-checkbox-cat">
                                        <?php
                                        $grade = array();
                            ...
                            <div class="content-half-part featured-image">
                                ...
                                <div class="dokan-feat-image-upload">
                                    ...
                                    <div class="instruction-inside<?php echo $instruction_class; ?>">
                                        ...
                                        <a href="#" class="dokan-feat-image-btn btn btn-sm"><?php _e( 'تحميل صورة الغلاف المنتج', 'dokan' ); ?></a>
                                    </div>
                                ...
                                <div class="dokan-product-gallery">
                                    <div class="dokan-side-body" id="dokan-product-images">
                                        ...
                                        <a href="#" class="add-product-images dokan-btn dokan-btn-sm dokan-btn-success"><?php _e( '+ إضافة المزيد من الصور', 'dokan' ); ?></a>
                                    </div>
                                </div> <!-- .product-gallery -->
                            </div><!-- .content-half-part -->
                        ...
                        <div class="dokan-product-inventory dokan-clearfix">
                            ...
                            <div class="dokan-side-right" >
                              <div class="dokan-form-group" style="width: 50%;display: none ">
                                ...
                                <div class="dokan-form-group " style="display: none !important;">
                               ...
                               <div class="show_if_stock dokan-stock-management-wrapper dokan-form-group dokan-clearfix">
                                    ...
                                    <div class="dokan-w3 " style="display: none;">
                                ...
                                <div class="dokan-clearfix downloadable downloadable_files hide_if_variation" style="margin-bottom: 20px;">
                                    <label class="dokan-checkbox-inline dokan-form-label" for="_downloadable">
                                        <input checked="checked" type="checkbox" id="_downloadable" name="_downloadable" value="yes" <?php checked( $_downloadable, 'yes' ); ?>>
                                        <?php _e( 'هذا هو منتج للتحميل', 'dokan' ); ?>
                                    </label>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th colspan="2">
                                                        ...
                                                        ?>"><?php _e( 'اضف ملف', 'dokan' ); ?></a>
                                                    </th>
                                                </tr>
                                            </tfoot>
                                            <thead>
                                                <tr>
                                                    <th><?php _e( 'اسم', 'dokan' ); ?> <span class="tips" title="<?php _e( 'هذا هو اسم التنزيل يظهر للعميل.', 'dokan' ); ?>">[?]</span></th>
                                                    <th><?php _e( 'URL ملف', 'dokan' ); ?> <span class="tips" title="<?php _e( 'هذا هو عنوان URL أو المسار المطلق لملف العملاء التي سوف تحصل الوصول إلى.', 'dokan' ); ?>">[?]</span></th>
                                                    <th><?php _e( 'عمل', 'dokan' ); ?></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                        ...
                        <div class="dokan-other-options dokan-clearfix">
                            ...
                            <div class="dokan-side-right" style="padding-left: 0px;">
                                ...
                                <div class="dokan-form-group" style="margin-top: 10px;display: none; ">
                        ...
                        <input type="submit" name="dokan_add_product" class="dokan-btn dokan-btn-theme dokan-btn-lg btn-block" value="<?php esc_attr_e( 'حفظ المنتج', 'dokan' ); ?>"/>
                        <input type="submit" hidden="true" name="dokan_add_product" id="click-done" value="<?php esc_attr_e( 'تحميل', 'dokan' ); ?>"/>
                    </form>
