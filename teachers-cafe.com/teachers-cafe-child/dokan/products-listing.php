    ...
    <div class="dokan-dashboard-content dokan-product-listing">
        ...
        <!--         <div class="product-listing-top dokan-clearfix">
                ...
                <table class="table table-striped product-listing-table">
                    <thead>
                        <tr>
                            <th><?php _e( 'صورة', 'dokan' ); ?></th>
                            <th><?php _e( 'اسم', 'dokan' ); ?></th>
                            <th><?php _e( 'الحالة', 'dokan' ); ?></th>
                            <th><?php _e( 'السعر', 'dokan' ); ?></th>
                            <th><?php _e( 'المشاهدات', 'dokan' ); ?></th>
                            <th><?php _e( 'تاريخ', 'dokan' ); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        if ( $product_query->have_posts() ) {
                            while ($product_query->have_posts()) {
                                ...
                                <tr<?php echo $tr_class; ?>>
                                    ...
                                    <td>
                                        <p><a style="color:black;" href="<?php echo dokan_edit_product_url( $post->ID ); ?>"><?php echo $product->get_title(); ?></a></p>
                                        <div class="row-actions">

                                            <span   class="edit"><a style="color:#58ceff !important;" href="<?php echo dokan_edit_product_url( $post->ID ); ?>?message=success&step=1&edit=yes"><?php _e( 'Edit', 'dokan' ); ?></a> | </span>
                                            <span  class="delete"><a style="color:red !important;"  onclick="return confirm('Are you sure?');" href="<?php echo wp_nonce_url( add_query_arg( array( 'action' => 'dokan-delete-product', 'product_id' => $post->ID ), dokan_get_navigation_url('products') ), 'dokan-delete-product' ); ?>"><?php _e( 'Delete Permanently', 'dokan' ); ?></a> | </span>
                                            <span   class="view"><a  style="color:#58ceff !important;" href="<?php echo get_permalink( $product->ID ); ?>" rel="permalink"><?php _e( 'View', 'dokan' ); ?></a></span>
                                   </div>
                                    </td>
