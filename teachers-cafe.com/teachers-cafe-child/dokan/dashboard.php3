...
$_file_type             = get_post_meta( $post_id, '_file_type', true );
...
$all_file = get_option('file_type');
$all_file = explode('|', $all_file);
$all_file = array_filter(array_map('trim', $all_file));
if (empty($all_file)){
    $all_file = array('100','200','300','400','500','600','700','800','900','1000');
}
?>
...
<input id="current_count_file" name="current_count_file" type="hidden" value="<?php echo $total; ?>" />
    ...
    <script>
        jQuery(document).ready(function($){
            $('input.input_text.wc_file_url').attr('readonly', true); 
        }) 
    </script>
            ...
            <?php if ( Dokan_Template_Shortcodes::$errors ) { ?>
                <div class="dokan-alert dokan-alert-danger">
                    ...
                    <?php foreach ( Dokan_Template_Shortcodes::$errors as $error) { ?>
                       <?php  $dem++; ?>
                       <?php echo '<span class="error'.$dem.' error-general">Error '.$error.'</span>'; ?>
                        <?php } ?>
                    </div>
                    <?php } ?>
                    ...
                    if ( $can_sell ) {
                        ...
                        <form class="dokan-product-edit-form 333" role="form" method="post">
                        <input type="hidden" name="post_status" value="pending" />
                            ...
                            <div class="dokan-form-top-area">
                                ...
                                <div class="content-half-part">
                                    ...
                                    <div class="hide_if_variation dokan-clearfix" style="">

                                        <!-- <div class="dokan-form-group dokan-clearfix dokan-price-container"> -->

                                            <!-- <div class="content-half-part regular-price"> -->
                                                <!-- <label for="_regular_price" class="form-label"><?php _e( 'Price ', 'dokan' ); ?><?php echo '('.get_woocommerce_currency_symbol().')'; ?></label> -->
                                                ...
                                                <!-- <div class="dokan-input-group" style="width:100%"> -->
                                                    ...
                                                    <!-- <select class="dokan-w3 dokan-form-control" name="_regular_price" style="width:100%">
                                        ...
                                        <!-- <div class="dokan-form-group dokan-clearfix dokan-file-container">

                                            <div class="content-half-part file-type">
                                                <label for="_file_type" class="form-label"><?php _e( 'File Type ', 'dokan' ); ?></label>

                                                <div class="dokan-input-group" style="width:100%">
                                                    <select class="dokan-w3 dokan-form-control" name="_file_type" style="width:100%">
                                                        <option value="">Select File Type</option> -->
                                                        <?php //foreach ($all_file as $key => $value) { ?>
                                                            <!-- <option <?php //if ( $_file_type ===  $key ) echo 'selected' ?> value="<?php echo $key; ?>"><?php echo $value; ?></option> -->
                                                        <?php //} ?>
                                                    <!-- </select>
                                                </div>
                                            </div> -->
                                    ...
                                    <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                        ...
                                        <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                            <div class="dokan-form-group content-relation">
                                                ...
                                                $product_cat = -1;
                                                $product_cat = array();
                                                $product_cat = wp_get_post_terms( $post_id, 'product_cat', array( 'fields' => 'ids') );

                                                if ( $product_cat ) {
                                                    $product_cat = reset( $product_cat );
                                                }
                                                wp_dropdown_categories( array(
                                                    'show_option_none' => __( '- Select a Educational Content -', 'dokan' ),
                                                    'orderby'          => 'ID', 
													'order'            => 'ASC',
                                                    'hierarchical'     => 1,
                                                    'parent'           => 0,
                                                    ...
                                                    'title_li'         => '',
                                                    'class'            => 'product_cat product_cat_upload dokan-form-control chosen cat_level_1',
                                                    'exclude'          => '',
...
<?php endif; ?>
<div class="dokan-product-inventory dokan-edit-row dokan-clearfix "style="padding-top:0px;border-top:0px;display:none !important;" >
	<div class="dokan-side-right">


	    <div class="dokan-form-group " style="width: 50%;display:none !important;">
	    ...
	    <div class="dokan-divider-top dokan-clearfix downloadable downloadable_files hide_if_variation">
	        <label class="dokan-checkbox-inline dokan-form-label" for="_downloadable" style="display: none">
	        ...
	        <?php endif; ?>
	        <div style="display:block !important;" class="dokan-side-body dokan-download-wrapper<?php //echo ( $_downloadable == 'yes' ) ? '' : ' dokan-hide'; ?>">
	    ...
	    <div class="dokan-clearfix dokan-variation-container">
	        <label class="checkbox-inline form-label" style="display:none" for="_has_attribute">
	            <input name="_has_attribute" value="no" type="hidden">
	            <input name="_has_attribute" id="_has_attribute" value="yes" checked="true" type="checkbox" <?php checked( $_has_attribute, 'yes' ); ?>>
	        ...
	        <?php if ( $_create_variations != 'yes' ): ?>
	            <div class="dokan-side-body dokan-attribute-content-wrapper dokan-hide" >
	                <table class="dokan-table dokan-attribute-options-table" style="display: none">
	                    <thead>
	                        <tr>
	                ...
	                <tbody>
	                    <?php if ( $product_attributes ): ?>
	                        <?php foreach( $product_attributes as $attribute ): ?>
	                            <tr class="dokan-attribute-options" style="display: none">
	                                <td width="20%">
	                    ...
	                    <?php else: ?>
	                        <tr class="dokan-attribute-options" style="display: none">
	                            ...
	                            <td colspan="4">
	                            	<input type="text" name="attribute_values[]" value="" class="dokan-form-control dokan-attribute-option-values">
                            	</td>
	                            <td><button class="dokan-btn dokan-btn-theme remove_attribute"><i class="fa fa-trash-o"></i></button></td>
	                        </tr>
	                    <?php endif ?>
	        ...
	        <div class="dokan-variation-content-wrapper" style="display: none"></div>
         ...
         <div class="dokan-product-description" style="display:none !important;">
...
<?php if ( 'yes' == get_option( 'woocommerce_calc_shipping' ) || 'yes' == get_option( 'woocommerce_calc_taxes' ) ): ?>
    ...
    <!--    <div class="dokan-side-left">
        ...
        <input type="hidden" value="yes" name="reload">
        <input type="submit" id="custom_dokan_new" name="dokan_add_product" class="dokan-btn dokan-btn-theme dokan-btn-lg btn-block" value="<?php esc_attr_e( 'Upload', 'dokan' ); ?>"/>
        <input type="submit" hidden="true" name="dokan_add_product" id="click-done" value="<?php esc_attr_e( 'Upload', 'dokan' ); ?>"/>
    </form>
...
<script type="text/html" id="tmpl-dokan-variations">
    <# var arrayFromPHP = <?php echo json_encode($all_price); ?>; #>
            ...
            <tbody>
                <# _.each( data.variation_item, function( el, i ) { #>
                    <tr>
                        ...
                        <td>
                            <select class="dokan-w3 dokan-form-control" name="variable_regular_price[{{i}}]" style="width:100%">
                                <option value="">Select Price</option>
                                <# _.each( arrayFromPHP, function( name, value ) { #>
