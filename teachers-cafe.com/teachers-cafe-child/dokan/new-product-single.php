...
$file_type              = get_post_meta($post_id, 'file-type', true);
...
?>
<div class="page-content single_new_pro">
    ...
    <script>
       jQuery(document).ready(function($){
        var _regular_price = jQuery('#_regular_price').val();
        jQuery('#select-price option[value='+_regular_price+']').attr( "selected", true );
...
<div class="dokan-dashboard-content dokan-product-edit">
    <header class="dokan-dashboard-header dokan-clearfix">
        <h1 class="entry-title">
                                    ...
                                    if ( dokan_is_seller_enabled( get_current_user_id() ) ) { ?>
                                        ...
                                        <div class="dokan-form-top-area">
                                            ...
                                            <div class="content-half-part">
                                                ...
                                                <div class=" dokan-clearfix" style="display: none;">
                                                    ...
                                                    <div class="dokan-form-group dokan-clearfix dokan-price-container">
                                                        ...
                                                        <div class="content-half-part regular-price">
                                                           ...
                                                           <div class="dokan-form-group " style="">
                                                                    <?php dokan_post_input_box( $post_id, 'file-type') ?>
                                                            </div>
                                                ...
                                                <div class="dokan-form-group">
                                                    <label for="edu-Country" class="form-label"><?php _e( 'البلد التربوي', 'dokan' ); ?></label>
                                                    <?php
                                                    $eduCountry = -1;
                                                    $eduCountry = array();
                                        ...
                                        <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                        <div class="dokan-form-group">
                                            <label for="edu-type" class="form-label"><?php _e( 'نوع التعليمي', 'dokan' ); ?></label>
                                            <?php
                                            $edutype = -1;
                                            $edutype = array();
            ...
            <div class="dokan-form-group select_price" >
                ...
                <select id="select-price" name="_regular_price" class="product_cat product_cat_upload dokan-form-control chosen cat_level_1">
                    ...
                    $i=0;
                    foreach($myArray as $my_Array){ 
                        echo '<option class="level-'.$i.'" value="'.$my_Array.'">KWD '.$my_Array.'</option>';                                                    
                        $i++;
                    }                                            
                    ?>  
                </select>
...
<?php endif; ?>
                                                        ...
                                                        if ( $gallery ) {
                                                            foreach ($gallery as $image_id) {
                                                                ...
                                                                <li class="image" data-attachment_id="<?php echo $image_id; ?>">
                                                                    ...
                                                                    <a href="#" class="action-delete" title="<?php esc_attr_e( 'حذف صورة', 'dokan' ); ?>">&times;</a>
                                                                </li>
                                                                <?php
                                                            }
                                                        }
                ...
                <div class="dokan-clearfix dokan-variation-container" style="display: none;">
                    <label class="checkbox-inline form-label hide_if_variation" for="_has_attribute">
                        ...
                        <?php _e( 'هذا المنتج لديها خيارات متعددة', 'dokan' ); ?>
...
<?php endif; ?>
<div class="dokan-other-options dokan-clearfix" style="display: none;">
    ...
    <div class="dokan-side-right" style="padding-left: 0px;">
        ...
        <div class="dokan-form-group" style="display: none;">
            ...
            <?php if ( $post_status != 'pending' ) { ?>
                ...
                <div class="dokan-form-group" style="margin-top: 10px;" style="display: none;">
