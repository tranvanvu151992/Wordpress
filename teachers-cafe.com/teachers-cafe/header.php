...
<a href="http://www.teachers-cafe.com/new-member-registration/?preview=true">Register</a>
</div>
...
<div id="openModal" class="modalDialog">
    <div>
        ...
        <aside id="wp_emember_login_widget-2" class="widget wp_eMember_widget">   
            <form action="" method="post" class="loginForm wp_emember_loginForm" name="wp_emember_loginForm" id="wp_emember_loginForm">
                <input type="hidden" id="_wpnonce" name="_wpnonce" value="111b310274"/>
                <input type="hidden" name="_wp_http_referer" value="/member-login/"/>        
