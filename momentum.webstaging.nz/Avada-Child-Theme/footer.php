                    ...
                    ?>
                        <div class="maps" id="maps" style="margin: 0 -30px;">
                            <iframe width="100%" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyC_hp-ZJmY3h3KslzvXvI7LV7n9YewZ4Dc&q=<?php echo tribe_get_address( $ID ); ?>" allowfullscreen>
                            </iframe>
                        </div>
                    <?php endif ?>
			</div>  <!-- #main -->
